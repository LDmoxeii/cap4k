...
class PebbleBootstrapRendererTest {
    ...
    fun `render default application module build with generated code dependencies`() {
        ...
        assertTrue(artifact.content.contains("url = uri(\"https://packages.aliyun.com/67053c6149e9309ce56b9e9e/maven/cap4k\")"))
        assertTrue(artifact.content.contains("username = providers.gradleProperty(\"aliyun.maven.username\").orNull"))
        assertTrue(artifact.content.contains("?: System.getenv(\"ALIYUN_MAVEN_USERNAME\")"))
        assertTrue(artifact.content.contains("password = providers.gradleProperty(\"aliyun.maven.password\").orNull"))
        assertTrue(artifact.content.contains("?: System.getenv(\"ALIYUN_MAVEN_PASSWORD\")"))
