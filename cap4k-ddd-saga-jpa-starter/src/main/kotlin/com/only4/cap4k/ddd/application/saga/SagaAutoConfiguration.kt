...
@AutoConfiguration
@EnableScheduling
@EnableConfigurationProperties(SagaProperties::class, SagaScheduleProperties::class)
@EnableJpaRepositories(basePackages = ["com.only4.cap4k.ddd.application.saga.persistence"])
@EntityScan(basePackages = ["com.only4.cap4k.ddd.application.saga.persistence"])
class SagaAutoConfiguration {
    ...
    @Bean
    fun sagaScheduleLoader(
        sagaScheduleProperties: SagaScheduleProperties,
        scheduleService: JpaSagaScheduleService,
    ): SagaScheduleLoader = SagaScheduleLoader(sagaScheduleProperties, scheduleService)
}

class SagaScheduleLoader(
