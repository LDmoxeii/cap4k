...
internal object JpaExecutionContextEnvelope {
    ...
    fun decode(envelope: String?): List<EncodedExecutionContextElement> {
        ...
        val values = try {
            ...
            throw ExecutionContextDecodingException("Malformed reliable Command ExecutionContext envelope", ex)
        } ?: throw ExecutionContextDecodingException("Malformed reliable Command ExecutionContext envelope")
    ...
    private fun requireSize(envelope: String) {
        ...
        require(size <= MAX_ENVELOPE_BYTES) {
            "Reliable Command ExecutionContext envelope exceeds $MAX_ENVELOPE_BYTES bytes: $size"
        }
    }
}
