...
- No Console-owned service or HTTP handler exposes Command search, Command retry/redrive, Event search, Event retry/redrive, Locker unlock, or Snowflake search.
...
- Locker Runtime and Snowflake Runtime modules, starters, schemas, APIs, and behavior remain available; only their Console-facing operations are removed.
...
- Locker Runtime or Snowflake Runtime retirement or redesign.
