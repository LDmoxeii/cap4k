...
| 写 source generation 输入 | [Generator DSL](generator-dsl.md), [Design JSON](design-json.md), [Value Object Manifest](value-object-manifest.md), [Enum Manifest](enum-manifest.md) |
