...
| `CHECKED_IN_SOURCE`、`GENERATED_SOURCE`、`GENERATED_RESOURCE`、`OUTPUT_ARTIFACT` 和输出根 | [Outputs](outputs.md) |
...
| 让 agent 检查项目与 framework capability | [Agent API](agent-api.md), [Gradle Plugin](gradle-plugin.md) |
| 写 source generation 输入 | [Generator DSL](generator-dsl.md), [Design JSON](design-json.md), [DB Schema Annotations](db-schema-annotations.md), [Value Object Manifest](value-object-manifest.md), [Enum Manifest](enum-manifest.md), [Agent API](agent-api.md), [Plan JSON](plan-json.md) |
| 审查 generation plan | [Plan JSON](plan-json.md), [Outputs](outputs.md), [Common Mistakes](common-mistakes.md) |
| 区分 checked-in skeleton 与 build-owned source/resource | [Outputs](outputs.md), [Plan JSON](plan-json.md) |
