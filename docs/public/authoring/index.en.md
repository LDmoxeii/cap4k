...
1. [Framework Positioning](framework-positioning.en.md)
2. [Getting Started](getting-started.en.md)
3. [Default Happy Path](default-happy-path.en.md)
...
- [Framework Positioning](framework-positioning.en.md)
- [Getting Started](getting-started.en.md)
- [Default Happy Path](default-happy-path.en.md)
...
- [Naming And Layout](naming-and-layout.md)
- [Generation / Handwritten Boundary](generation-boundaries.md)
- [Example Contract](example-contract.md)
