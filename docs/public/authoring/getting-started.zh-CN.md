...
3. 需要端到端 authoring 顺序时，读 [项目编写工作流](project-authoring-workflow.zh-CN.md)
4. 需要建立项目骨架时，读 [Bootstrap](generator/bootstrap.zh-CN.md)
5. 需要更清楚的概念边界时，再读 [框架定位](framework-positioning.zh-CN.md)
...
- [Bootstrap](generator/bootstrap.zh-CN.md)
