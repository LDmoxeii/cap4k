...
- 复制到 `src-generated/main/kotlin` 的内容只是审计快照，不是活跃生成输出；活跃生成源码仍在模块本地 `build/generated/cap4k/main/kotlin`。详见 [项目编写工作流](project-authoring-workflow.md#4-区分生成物骨架快照手写代码)。
