...
最小工作流的示例语境固定为 [示例总览](examples/index.md) 中的内容发布与媒体处理项目。先用 `CreateContentDraftCmd -> SubmitContentForReviewCmd -> ApproveContentReviewCmd -> StartMediaProcessingCmd` 看清默认主链路，再讨论高级概念或生成边界。
