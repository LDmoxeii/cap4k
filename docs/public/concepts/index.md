...
概念分成两组。`modeling-building-blocks/` 说明业务模型由什么组成，包括聚合、实体、值对象、Strong ID、Factory、Domain Service、Domain Event 和 Integration Event。`execution-and-ownership/` 说明写入、读取、外部能力、反应、持久化、生成骨架和手写逻辑如何被拥有，包括 Command / Query separation、Command、Query、Actor Endpoint、Subscriber、Scheduled Reaction、Repository、Unit of Work、Mediator、External Capability Anti-Corruption Layer，以及 generated skeleton 与 handwritten logic 的边界。
...
- [Actor Endpoint](execution-and-ownership/actor-endpoint.md)
