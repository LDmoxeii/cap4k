...
private val TYPE_SHAPES = mapOf(
    ...
    "capabilitysendermethod" to "parallelogram",
    "validator" to "parallelogram",
    "command" to "hexagon",
    "commandhandler" to "subroutine",
    "query" to "hexagon",
    "queryhandler" to "subroutine",
    "capability" to "hexagon",
    "capabilityhandler" to "subroutine",
...
private val CLASS_DEFS = mapOf(
    ...
    "capabilitysendermethod" to "fill:#BBF7D0,stroke:#15803D,color:#0F172A",
    ...
    "capability" to "fill:#86EFAC,stroke:#15803D,color:#0F172A",
    "capabilityhandler" to "fill:#22C55E,stroke:#166534,color:#F0FDF4",
