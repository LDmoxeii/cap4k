        ...
        rootBuildFile.writeText(
            rootBuildFile.readText()
                ...
                .replace(
                    ...
                    """includeTables.set(listOf("MixedCaseRecord"))""",
                )
        )
                        ...
                        MetadataSources(registry)
                            ...
                            .use { sessionFactory ->
                                ...
                                sessionFactory.openSession().use { session ->
                                    ...
                                    val entity = MixedCaseRecord(id = 0L, title = "active")
                                ...
                                sessionFactory.openSession().use { session ->
                                    ...
                                    session.remove(session.find(MixedCaseRecord::class.java, id))
                                    session.flush()
                                    transaction.commit()
                                }
                                ...
                                DriverManager.getConnection(jdbcUrl, "sa", "secret").use { connection ->
                                    connection.createStatement().use { statement ->
                                        statement.executeQuery(
                                            "select \"Id\", \"Deleted\" from \"MixedCaseRecord\""
                                        ).use { rows ->
