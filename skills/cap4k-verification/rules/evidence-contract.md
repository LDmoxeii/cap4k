...
- When verifying generator input-boundary guidance, scan active docs and skills for removed public design switches, `sources.enumManifest`, core `validator` design tags, and stale value-object/type-registry guidance. Historical specs or plans may mention removed terms only as history, unsupported behavior, or removal notes.
