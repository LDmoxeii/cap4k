...
- Do not ask users to generate aggregate-root IDs inside `Mediator.uow.save(...)`, persist listeners, or save-time reflection paths. New aggregate roots should enter the UoW with their generated Strong ID already assigned by the creation/factory path.
