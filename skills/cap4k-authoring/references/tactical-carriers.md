...
- Integration Event is stable published language across a service or bounded-context boundary. A business subscriber interprets typed facts and delegates writes; transport intake belongs to runtime adapters.
