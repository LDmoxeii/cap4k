...
4. Draft the DDL contract when DB-first generation is likely, including aggregate-root markers, parent/child relations, enum annotations, generated IDs, versions, soft delete, managed fields, and uniqueness.
...
6. Note unsupported design tags explicitly: `integration_event`, `value_object`, and `domain_service`.
