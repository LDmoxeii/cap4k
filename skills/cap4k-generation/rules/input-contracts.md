...
- Missing concept or carrier facts route back to `cap4k-tactical-modeling`; missing placement, design-contract, or input-surface decisions route to `cap4k-technical-design`; existing facts with missing skeletons stay in `cap4k-generation`.
