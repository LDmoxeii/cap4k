...
internal object IntegrationEventExecutionContextEnvelope {
    ...
    fun decode(rawEnvelope: Any?): List<EncodedExecutionContextElement> {
        ...
        val values = try {
            ...
            throw ExecutionContextDecodingException("Malformed HTTP Integration Event ExecutionContext envelope", ex)
        } ?: throw ExecutionContextDecodingException("Malformed HTTP Integration Event ExecutionContext envelope")
